  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-13">
        ...
        <div className="space-y-7.5">
            <h1 className="text-[45px] font-extrabold">Great Tea, Freshly <br /> Presented</h1>
            ...
            <h4 className="font-extrabold mb-4">Unique Taste</h4>
            ...
            <h4 className="font-extrabold  mb-4">Premium Quality</h4>
